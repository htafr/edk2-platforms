...
// static u64 rocket_tlbr_flush_limit(const struct fdt_match *match)
// {
//   /*
...
// static int rocket_fdt_fixup(void *fdt, const struct fdt_match *match)
// {
//   /*
...
// static const struct fdt_match rocket_match[] = {
//   { .compatible = "litex,soc" },
//   { },
// };

// const struct platform_override rocket = {
//   .match_table = rocket_match,
//   .tlbr_flush_limit = rocket_tlbr_flush_limit,
//   .fdt_fixup = rocket_fdt_fixup,
// };
