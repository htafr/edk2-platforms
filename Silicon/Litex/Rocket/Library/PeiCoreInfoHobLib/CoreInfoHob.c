  ...
  )
{
  ...
  CommonFirmwareContextHartSpecificInfo (
      ...
      ParentProcessorGuid,
      ParentProcessorUid,
      (EFI_GUID *)PcdGetPtr (PcdLitexRocketCoreGuid),
      HartId,
      IsBootHart,
  ...
  )
{
  ...
  L1CacheDataHob.ProcessorGuid = *((EFI_GUID *)PcdGetPtr (PcdLitexRocketCoreGuid));
  ...
  L1CacheDataHob.SmbiosType7Cache.MaximumCacheSize = 0x4000;
  L1CacheDataHob.SmbiosType7Cache.InstalledSize = 0x4000;
  ...
  L1CacheDataHob.SmbiosType7Cache.ErrorCorrectionType = CacheErrorUnknown;
  L1CacheDataHob.SmbiosType7Cache.SystemCacheType = CacheTypeUnified;
  L1CacheDataHob.SmbiosType7Cache.Associativity = CacheAssociativity4Way;
  ...
  )
{
  ...
  ProcessorDataHob.ProcessorGuid = *((EFI_GUID *)PcdGetPtr (PcdLitexRocketCoreGuid));
  ...
  ProcessorDataHob.SmbiosType4Processor.CoreCount = (UINT8)FixedPcdGet32 (PcdNumberofRocketCores);
  ProcessorDataHob.SmbiosType4Processor.EnabledCoreCount = (UINT8)FixedPcdGet32 (PcdNumberofRocketCores);
  ProcessorDataHob.SmbiosType4Processor.ThreadCount = (UINT8)FixedPcdGet32 (PcdNumberofRocketCores);
